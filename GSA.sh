...
# Reference data files (g100_eur) and gene locations file were obtained from the MAGMA homepage

magma --annotate window=20,20 --snp-loc g1000_eur.bim --gene-loc NCBI37.3.gene.loc --out ncbi37_eur

## Step 2: Gene analysis ##

#Compute gene P values for each GWAS dataset (SZ, ASD, IQ and EA).
...
# First convert list of HGNC symbols to entrez IDs in the file format accepted by MAGMA by running hgnc2entrez.R. Combine multiple genesets together:
